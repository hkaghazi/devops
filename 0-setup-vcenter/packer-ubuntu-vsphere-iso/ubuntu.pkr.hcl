...
source "vsphere-iso" "ubuntu" {
  http_ip = "192.168.1.160" # only when you are behind vpn
  ...
  iso_paths             = ["[${var.vsphere_datastore}] ubuntu-24.04.2-live-server-amd64.iso"]
  cd_content            = {
  ...
  communicator          = "ssh"
  ssh_host              = "192.168.1.250" # the static IP you gave in cloud-init
